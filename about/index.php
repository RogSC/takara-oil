    ...
    <section class="catalog-element">
        <div class="my-container catalog-element__container">
            ...
            <div class="catalog__title catalog-element__title title-red-line">
                <h2>моторное масло takara Race master 0W-40</h2>
            </div>
            <div class="catalog-element__section catalog-element__chars">
                ...
                <div class="catalog-element__chars-element">
                    <div class="catalog-element__chars-element-title">
                        ...
                        catalog-element__chars-element-p">Название</p>
                    </div>
                    <div class="catalog-element__chars-element-description">
                        <p class="catalog-element__chars-element-description-p
                        catalog-element__chars-element-p">TAKARA RACE MASTER 0W-40</p>
                    </div>
                </div>
                <div class="catalog-element__chars-element">
                    <div class="catalog-element__chars-element-title">
                        <p class="catalog-element__chars-element-title-p
                        catalog-element__chars-element-p">Категория</p>
                    </div>
                    <div class="catalog-element__chars-element-description">
                        <p class="catalog-element__chars-element-description-p
                        catalog-element__chars-element-p">Моторное масло для 4-х тактных двигателей</p>
                    </div>
                </div>
                <div class="catalog-element__chars-element">
                    <div class="catalog-element__chars-element-title">
                        <p class="catalog-element__chars-element-title-p
                        catalog-element__chars-element-p">Тип</p>
                    </div>
                    <div class="catalog-element__chars-element-description">
                        <p class="catalog-element__chars-element-description-p
                        catalog-element__chars-element-p">Полностью синтетическое (PAO + ESTER)</p>
                    </div>
                </div>
                <div class="catalog-element__chars-element">
                    <div class="catalog-element__chars-element-title">
                        <p class="catalog-element__chars-element-title-p
                        catalog-element__chars-element-p">Применение</p>
                    </div>
                    <div class="catalog-element__chars-element-description">
                        <p class="catalog-element__chars-element-description-p
                        catalog-element__chars-element-p">Бензиновые и дизельные двигатели </p>
                    </div>
                </div>
                <div class="catalog-element__chars-element">
                    <div class="catalog-element__chars-element-title">
                        <p class="catalog-element__chars-element-title-p
                        catalog-element__chars-element-p">классификация</p>
                    </div>
                    <div class="catalog-element__chars-element-description">
                        <p class="catalog-element__chars-element-description-p
                        catalog-element__chars-element-p">API SN/CF, A3/B3, A3/B4</p>
                    </div>
                </div>
                <div class="catalog-element__chars-element">
                    <div class="catalog-element__chars-element-title">
                        <p class="catalog-element__chars-element-title-p
                        catalog-element__chars-element-p">Вязкость</p>
                    </div>
                    <div class="catalog-element__chars-element-description">
                        <p class="catalog-element__chars-element-description-p
                        catalog-element__chars-element-p">0W-40</p>
                    </div>
                </div>
            ...
            <div class="catalog-element__section catalog-element__description">
                ...
                <div class="catalog-element__description-text">
                    <p class="catalog-element__description-text-p">
                        Интервалы замены*:<br>
                        10,000 км для автомобилей с пробегом до 100,000 км<br>
                        7,000 км для автомобилей с пробегом свыше 100,000 км<br>
                        <br>
                        * Интервалы замены могут меняться в зависимости от условий
                        эксплуатации и технического состояния автомобиля, стиля езды
                        водителя и других факторов.
                    </p>
                </div>
            </div>
            <div class="catalog-element__section catalog-element__features">
                <div class="catalog-element__section-title">
                    <p class="catalog-element__section-title-p">Преимущества:</p>
                </div>
                <ul class="catalog-element__features-items">
                    <li class="catalog-element__features-item">
                        <p>Специально разработано для современных спортивных автомобилей,
                            а также европейских автомобилей представительского класса,
                            в которых автопроизводители рекомендуют использовать полностью
                            синтетические моторные масла с вязкостью 0W-40. Вязкость 0W-40
                            официально рекомендована для NISSAN GT-R (R35), HONDA S2000,
                            автомобилей PORSCHE, а также MERCEDES BENZ, BMW и AUDI спортивных
                            комплектаций.</p>
                    </li>
                    <li class="catalog-element__features-item">
                        <p>Надежно защищает двигатель от перегрева в экстремальных условиях
                            эксплуатации, таких как спортивная и внедорожная езда, а также
                            при эксплуатации в жарком климате при температуре воздуха до 40С,
                            позволяя по максимуму реализовать его потеницал. </p>
                    </li>
                    <li class="catalog-element__features-item">
                        <p>Благодаря расширенному диапазону вязкости и прочной защитной пленке,
                            образуемой в результате взаимодействия синтетической основы PAO
                            и новейшего пакета присадок, обладает отличной термоустоичивостью
                            и стабильностью эксплутационных характеристик, сохраняя свою
                            вязкость и противоизносные свойства даже после длительной работы
                            двигателя с максимальной нагрузкой. </p>
                    </li>
                    <li class="catalog-element__features-item">
                        <p>Зимняя вязкость 0W в сочетании с полностью синтетической основой
                            PAO обеспечивает легкий пуск и отличную прокачиваемость масла
                            при низких зимних температрурах. </p>
                    </li>
                    <li class="catalog-element__features-item">
                        <p>Специальная защитная формула с использованием не только PAO, но и
                            эстеровой базы позволяет снизить до минимума процессы трения в
                            двигателе и полностью мобилизовать его ресурс, обеспечивая
                            максимальный результат в спортивных состязаниях профессионалов
                            автоспорта.</p>
                    </li>
                </ul>
            </div>
