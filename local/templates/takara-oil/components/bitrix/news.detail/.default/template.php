        ...
        <div class="article-item__container">
            <div class="article__header">
                <div class="article__title">
                    <p class="article__title-p">как правильно менять масло в двигателе? </p>
                </div>
            ...
            <div class="article__description">
                <p> Значимость этих проблем настолько очевидна, что дальнейшее развитие
                    ...
                    развития. С другой стороны начало повседневной работы по формированию
                    позиции позволяет оценить значение позиций, занимаемых участниками в
                    отношении поставленных задач.
                </p>
            </div>
            <div class="article__img-list">
