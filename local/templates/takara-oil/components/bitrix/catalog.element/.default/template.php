...
<? //dump($arResult)?>
    ...
    <section class="catalog-element">
        <div class="my-container catalog-element__container">
                ...
                <div class="catalog-element_left-section">
                    ...
                    <div class="catalog-element__section catalog-element__chars">
                        ...
                        <div class="catalog-element__btn">
                            <a href="#tabs" class="button standard-paragraph">Все характеристики</a>
                        </div>
                    </div>
                    <div class="catalog-element__section catalog-element__description">
                        ...
                        <div class="catalog-element__description-text">
                            <p class="catalog-element__description-text-p">
                                <?= $arResult['PROPERTIES']['PRODUCT_DESCRIPTION_SHORT']['VALUE'] ?>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="catalog-element__section catalog-element__features">
                <div class="catalog-element__section-title">
                    <p class="catalog-element__section-title-p"><?= $arResult['PROPERTIES']['PRODUCT_FEATURES']['NAME'] ?>
                        :</p>
                </div>
            ...
            <div class="catalog-element__section catalog-element__packing">
                ...
                <ul class="catalog-element__packing-items">
                    <? foreach ($arResult['PROPERTIES']['PRODUCT_PACKING']['VALUE'] as $index => $arPacking): ?>
                        <li class="catalog-element__packing-item">
                            <img alt="<? echo $arResult["NAME"] ?>"
                                 src="<?= $arResult["PREVIEW_PICTURE"]["SRC"] ?>"
                                 width="<?= $arResult["PREVIEW_PICTURE"]["WIDTH"] / ($index + 1) ?>"
                                 height="<?= $arResult["PREVIEW_PICTURE"]["HEIGHT"] / ($index + 1) ?>">
                            <p class="standard-paragraph catalog-element__packing-item-p"><?= $arPacking ?></p>
                        </li>
                    <? endforeach ?>
                </ul>
            </div>
            <div class="catalog-element__section catalog-element__buttons" id="tabs">
                <ul class="catalog-element__buttons-list">
                    ...
                    while ($obElement = $rsElement->GetNextElement()):?>
                        <? $arItem = (array)$obElement ?>
                        <li class="catalog-element__buttons-item">
                            <p class="standard-paragraph"><?= $arItem["fields"]["NAME"] ?></p>
                        </li>
                        <? $anotherTab[$index]["NAME"] = $arItem["fields"]["NAME"] ?>
                        <? $anotherTab[$index]["DETAIL_TEXT"] = $arItem["fields"]["DETAIL_TEXT"] ?>
                        <? $index++ ?>
                    <? endwhile ?>
                ...
                <div class="catalog-element__buttons-visible-section">
                    ...
                    <div class="catalog-element__section catalog-element__section-container">
                        <p class="catalog-element__description-text-p">
                    ...
                    <div class="catalog-element__section catalog-element__section-container
                            catalog-element__questions-container">
                        <div class="catalog-element__questions">
                            ...
                            <?/*
                            $arQuestionsSelect = Array("ID", "NAME", "USER_NAME", "DATE_CREATE", "PROPERTY_AUTHOR",
                                "PROPERTY_QUESTION_DATE_TIME", "PROPERTY_ANSWER", "PROPERTY_ANSWER_DATE_TIME");
                            $arQuestionsFilter = Array("IBLOCK_ID" => "20", "ACTIVE" => "Y");
                            $questionsElement = CIBlockElement::GetList(Array(), $arQuestionsFilter, false, false, $arQuestionsSelect);

                            while ($obElement = $questionsElement->GetNextElement()):*/?><!--
                                <?/* $arItem = (array)$obElement */?>
                            <?/* //dump($arItem)*/?>

                                <div class="catalog-element__question">
                                    <div class="element__questions-time">
                                        <time><?/*=substr($arItem["fields"]["DATE_CREATE"], 0, 10).", ".substr($arItem["fields"]["DATE_CREATE"], 11, 5)*/?></time>
                                    </div>
                                    <div class="element__questions-author">
                                        <p class="element__questions-author-p">
                                    <span class="element__questions-author-p_red">автор: </span><?/*= $arItem["fields"]["USER_NAME"] */?>
                                        </p>
                                    </div>
                                    <div class="element__question">
                                        <p class="element__question-p"><?/*= $arItem["fields"]["NAME"] */?></p>
                                    </div>
                                    <div class="img__redline"></div>
                                    <div class="element__questions-time">
                                        <time><?/*= substr($arItem["fields"]["PROPERTY_ANSWER_DATE_TIME_VALUE"], 0, 10).", ".substr($arItem["fields"]["PROPERTY_ANSWER_DATE_TIME_VALUE"], 11, 5)*/?></time>
                                    </div>
                                    <div class="element__questions-author">
                                    ...
                                    <div class="element__question">
                                        <p class="element__question-p"><?/*= $arItem["fields"]["PROPERTY_ANSWER_VALUE"] */?></p>
                                    </div>
                                </div>
                            --><?/* endwhile */?>
                        </div>
                    ...
                    <div class="catalog-element__section catalog-element__section-container">
                        <?= $anotherTab["3"]["DETAIL_TEXT"] ?>
                    </div>
                    <div class="catalog-element__section catalog-element__section-container">
                        <?= $anotherTab["4"]["DETAIL_TEXT"] ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript" src="<?= SITE_TEMPLATE_PATH ?>/frontend/js/catalogTabs.js"></script>
